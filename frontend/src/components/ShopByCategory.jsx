...
import { Book, Laptop, Shirt, Sofa, Gamepad2, Headphones, Loader2 } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {categories.map((cat, index) => (
          ...
          >
            ...
            <p className="text-gray-600 text-sm mb-4">{cat.description || `Browse all ${cat.name} items.`}</p>
