...
import { 
  Heart, MessageCircle, MapPin, Clock, Loader2, 
  ChevronLeft, Share2, Info, Edit, Trash2, Save, X,
  Send, ThumbsUp, AlertTriangle, User as UserIcon
} from "lucide-react";
    ...
    return (
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-6">
          ...
          <Link to="/student" className="text-blue-600 hover:underline flex items-center gap-2">
          ...
          <div className="flex flex-col">
            {isEditing ? (
              ...
              <>
                ...
                <h1 className="text-4xl font-black text-gray-900 mb-3">{item.title}</h1>
                
                <div className="flex items-center gap-6 text-sm text-gray-400 font-bold mb-8">
                  <div className="flex items-center gap-1.5">
                    <Clock size={18} /> {new Date(item.createdAt).toLocaleDateString()}
                  </div>
                  <div className="flex items-center gap-1.5">
                ...
                <div className="text-5xl font-black text-blue-600 mb-10">
                  {item.price.toLocaleString()} <span className="text-xl font-bold opacity-70">ETB</span>
                </div>

                <div className="border-t border-gray-100 py-8 mb-4">
                  <h3 className="font-black text-gray-900 mb-4 text-lg">About this item</h3>
                    ...
                    <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100 mb-6 group hover:border-blue-200 transition">
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h4 className="font-black text-gray-900">{item.owner_id?.full_name}</h4>
                            <p className="text-xs text-gray-500 font-bold uppercase">{item.owner_id?.department || "Student"}</p>
                          </div>
                        </div>
                        <Link 
                  ...
                  <div className="flex flex-col gap-4 mt-auto">
                    <div className="bg-blue-50 p-6 rounded-2xl border border-blue-100 mb-4">
                      <h4 className="font-black text-blue-900 mb-1 flex items-center gap-2">
                        <Info size={20} /> {isAdmin ? "Admin Controls" : "Owner Dashboard"}
                      </h4>
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 md:p-12">
          ...
          <div className="space-y-8 mb-10">
            {item.comments && item.comments.length > 0 ? (
              ...
              <div className="py-10 text-center flex flex-col items-center gap-3 text-gray-400">
                ...
                <p className="font-black italic">No questions yet. Be the first to ask!</p>
              </div>
            )}
          </div>
          ...
          <form onSubmit={handleAddComment} className="relative">
             <textarea 
               ...
               placeholder={currentUser ? "Ask the seller a question..." : "Login to post a comment"}
             ...
             >
               {submittingComment ? <Loader2 className="animate-spin" size={24} /> : <Send size={24} />}
             </button>
          </form>
        </div>
      </main>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-6">
          <div className="bg-white rounded-3xl w-full max-w-md p-8 shadow-2xl animate-in fade-in zoom-in duration-300">
            ...
            <p className="text-sm text-gray-500 font-bold mb-6 italic">
              Please let us know why you are reporting this listing. We take student safety seriously.
            </p>
            ...
            <div className="flex gap-4">
              ...
              >
                {submittingReport ? <Loader2 className="animate-spin mx-auto" size={24} /> : "Submit Report"}
              </button>
            </div>
          </div>
        </div>
